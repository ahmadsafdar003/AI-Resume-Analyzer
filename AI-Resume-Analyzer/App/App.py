# Developed by dnoobnerd [https://ahmadsafdar.netlify.app/]    Made with Streamlit
###### Packages Used ######
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='',db='ahmad')
...
def run():
    ...
    link = '<b>Built by <a href="https://ahmadsafdar.netlify.app/" style="text-decoration: none; color: #021659;">Ahmad Safdar</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>ahmad1122</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built by 
            <a href="https://ahmadsafdar.netlify.app/" style="text-decoration: none; color: grey;">Ahmad Safdar</a> 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'ahmad1122':
                ...
                st.success("Welcome Ahmad ! Total %d " % values + " User's Have Used Our Tool : )")                
